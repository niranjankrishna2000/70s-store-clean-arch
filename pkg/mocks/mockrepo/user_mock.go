...
func (m *MockUserRepository) ClearCart(cartID int) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) ClearCart(cartID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClearCart", reflect.TypeOf((*MockUserRepository)(nil).ClearCart), cartID)
}
...
func (m *MockUserRepository) EditUsername(id int, username string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditUsername", id, username)
	ret0, _ := ret[0].(error)
	return ret0
}

// EditUsername indicates an expected call of EditUsername.
func (mr *MockUserRepositoryMockRecorder) EditUsername(id, username interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUsername", reflect.TypeOf((*MockUserRepository)(nil).EditUsername), id, username)
}
...
func (m *MockUserRepository) FindUserByEmail(user models.UserLogin) (models.UserResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserIDByOrderID(orderID int) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindUserIDByOrderID", orderID)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) FindUserIDByOrderID(orderID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindUserIDByOrderID", reflect.TypeOf((*MockUserRepository)(nil).FindUserIDByOrderID), orderID)
}
...
func (m *MockUserRepository) GetProductsInCart(cart_id, page, limit int) ([]int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProductsInCart", cart_id, page, limit)
	ret0, _ := ret[0].([]int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) GetProductsInCart(cart_id, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProductsInCart", reflect.TypeOf((*MockUserRepository)(nil).GetProductsInCart), cart_id, page, limit)
}

// GetUserDetails mocks base method.
func (m *MockUserRepository) GetUserDetails(id int) (models.UserResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) RemoveFromCart(id, inventoryID int) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) RemoveFromCart(id, inventoryID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveFromCart", reflect.TypeOf((*MockUserRepository)(nil).RemoveFromCart), id, inventoryID)
}

// SignUp mocks base method.
func (m *MockUserRepository) SignUp(user models.UserDetails) (models.UserResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) SignUp(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SignUp", reflect.TypeOf((*MockUserRepository)(nil).SignUp), user)
}
